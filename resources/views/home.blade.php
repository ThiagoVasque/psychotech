                    ...
                    <div class="col-md-4">
                        <div class="card card-custom">
                            <div class="card-body">
                                ...
                                <p class="card-text">Agende consultas e converse com médicos em questão de minutos, sem
                                    sair de casa.</p>
                                <p class="extra-info">Na PsychoTech, agendar consultas médicas é fácil, rápido e sem a
                                    ...
                                    forma ágil e com total proteção aos seus dados, permitindo que você cuide da sua
                                    saúde de maneira conveniente e tranquila.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card card-custom">
                            <div class="card-body">
                                ...
                                <p class="card-text">Receba atendimento médico no conforto do seu lar, evitando
                                    deslocamentos e filas.</p>
                                <p class="extra-info">Na PsychoTech, conectamos você a profissionais de saúde com
                    ...
                    <div class="col-md-4">
                        <div class="card card-custom">
                            <div class="card-body">
                                ...
                                <p class="card-text">Protegemos seus dados pessoais e garantimos um ambiente seguro para
                                    suas consultas.</p>
                                <p class="extra-info">Valorizamos a sua privacidade e nos comprometemos em proteger seus
...
<footer class="text-white text-center " style="background-color: #821AD1; margin-top: 40px;">
    <!-- Footer -->
    <div class="container">
