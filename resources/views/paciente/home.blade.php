        ...
        <div class="col-md-4">
            <div class="card card-custom text-center mb-4 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('paciente.consultas') }}" class="btn btn-primary btn-custom">Ver Sessões</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card card-custom text-center mb-4 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('paciente.servicos') }}" class="btn btn-primary btn-custom">Ver Doutores</a>
                </div>
            </div>
        </div>
